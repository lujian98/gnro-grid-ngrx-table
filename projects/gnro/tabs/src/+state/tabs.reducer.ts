...
export const gnroTabsOnActions: GnroOnAction<TabsState<unknown>>[] = [
...
export const gnroTabsReducer = createReducer(initialState(), ...gnroTabsOnActions);
export const gnroTabsFeature = createFeature({ name: 'gnroTabs', reducer: gnroTabsReducer });
