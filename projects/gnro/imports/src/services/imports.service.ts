...
import { GnroBackendService, GnroUploadFile, ACCEPT_JSON_API_HEADER, GnroDataType } from '@gnro/ui/core';
...
export class GnroImportsService {
  ...
  saveImportsRecords(urlKey: string, records: GnroDataType[]): Observable<any> {
