...
import { GnroRadioGroupDirective, MAT_RADIO_GROUP } from './radio-group.directive';
...
export class GnroRadioComponent implements OnInit, AfterViewInit, DoCheck, OnDestroy {
  ...
  constructor() {
    const radioGroup = inject<GnroRadioGroupDirective>(MAT_RADIO_GROUP, { optional: true })!;
